...
return [
    ...
    'oracle_oagwxp' => [
        'driver' => 'oracle',
        'host' => env('DB_HOST_ORACLE_OAGWXP', ''),
        'port' => env('DB_PORT_ORACLE_OAGWXP', '1521'),
        'database' => env('DB_DATABASE_ORACLE_OAGWXP', ''),
        'username' => env('DB_USERNAME_ORACLE_OAGWXP', ''),
        'password' => env('DB_PASSWORD_ORACLE_OAGWXP', ''),
        'charset' => env('DB_CHARSET', 'AL32UTF8'),
        'prefix' => env('DB_PREFIX', ''),
    ],
];
