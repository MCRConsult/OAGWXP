		...
		try {
            ...
            foreach ($requistion->lines as $key => $line) {
                ...
                if ($line->amount > 0) {
                    ...
                    $glDrInf->line_number               = $line->seq_number;
                    ...
                    $glCrInf->line_number               = $line->seq_number;
                    ...
                    $glCrInf->entered_cr                = abs($line->amount);
                    $glCrInf->entered_dr                = 0;
                    $glCrInf->accounted_cr              = abs($line->amount);
            ...
            if ($cashAccount) {
                ...
                $glCrInf->currency_conversion_type  = '';
                $glCrInf->currency_conversion_rate  = '';
                $glCrInf->line_number               = count($requistion->lines)+1;
                $glCrInf->segment1                  = $coa[0];
                $glCrInf->segment2                  = $coa[1];
                $glCrInf->segment3                  = $coa[2];
                $glCrInf->segment4                  = $coa[3];
