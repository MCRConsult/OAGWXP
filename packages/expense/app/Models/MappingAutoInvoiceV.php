...
class MappingAutoInvoiceV extends Model
{
    ...
    // MAPPING CLEARING FROM REQUISITION
    public function mappingClearingAccount($header, $expeseType)
    {
        ...
        if ($segments[4] == 510) {
            ...
            $segments[5] = isset($expenseRules[5])? $expenseRules[5]: null;
            $segments[6] = isset($expenseRules[6])? $expenseRules[6]: null;
            $segments[7] = isset($expenseRules[7])? $expenseRules[7]: null;
            $segments[8] = isset($expenseRules[8])? $expenseRules[8]: null;
            $segments[9] = null;
        }
        // SEGMENT10
