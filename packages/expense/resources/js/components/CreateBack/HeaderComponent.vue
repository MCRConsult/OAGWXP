                    ...
                    <!-- <div class="card-body" style="padding: 10px !important"> -->
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group" style="padding: 5px;">
                                    <label class="control-label">
                                        <strong> ชื่อประเภทเอกสาร <span class="text-danger"> *</span></strong>
                                    </label><br>
                                    <documentCategory
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group" style="padding: 5px;">
                                    <label class="control-label">
                                        <strong> เลขที่ใบสำคัญ <span class="text-danger"> *</span></strong>
                                    </label><br>
                            ...
                            <div class="col-md-3">
                                <div class="form-group" style="padding: 5px;">
                                    <label class="control-label">
                                        <strong> ผู้รับผิดชอบ <span class="text-danger"> *</span></strong>
                                    </label><br>
                        ...
                        <div class="row">
                                    ...
                                    <label class="control-label" style="margin-bottom: 0.4rem;">
                                        <strong> ชื่อสั่งจ่าย <span class="text-danger"> *</span></strong> &nbsp;
                                            <input type="checkbox" class="m-1"
                                                name="more_supplier" 
                                                v-model="requisition.more_supplier" 
                                                @click="chooseSupplier()"
                                            > หลายราย <span class="text-danger">(กรอกหน้าถัดไป)</span>
                                    </label><br>
                                    <supplier
                            ...
                            <div class="col-md-3">
                                <div class="form-group" style="padding: 5px;">
                                    ...
                                    <supplierBank
                                        :setData="requisition.supplier_bank"
                                        :error="errors.doc_category"
                                        :editFlag="true"
                                    ></supplierBank>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group" style="padding: 5px;">
                                    <label class="control-label">
                                        <strong> เลขที่ใบแจ้งหนี้ <span class="text-danger"> *</span></strong>
                                    </label><br>
                                    <el-input v-model="requisition.invoice_number" style="width: 100%;" placeholder="" maxlength="50" show-word-limit/>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group" style="padding: 5px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group" style="padding: 5px;">
                                    <label class="control-label">
                                        <strong> ใบโอนล้างถึงที่สุด </strong>
                                    </label><br>
                                    <yesnoType
...
<script>
    ...
    export default {
        components: {
            documentCategory, supplier, supplierBank, paymentType, paymentMethod, currency, yesnoType
        },
        props: ['invoiceTypes'],
        data() {
            return {
