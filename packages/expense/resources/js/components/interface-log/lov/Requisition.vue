    ...
    <div class="el_select">
        <el-select v-model="value"
            ...
            <el-option
                ...
                :key="row.trans_number"
                :label="row.trans_number"
                :value="row.trans_number"
            >
            </el-option>
        </el-select>
    </div>
...
export default {
    ...
    methods: {
        getDataRows (query) {
            this.loading = true;
            axios.get(`/OAGWXP/api/invoice/get-requisition`, {
                params: {
                    keyword: query,
            ...
            .then(res => {
                ...
                this.$emit('setRequisition', {requisition: this.value});
            })
            .catch((error) => {
