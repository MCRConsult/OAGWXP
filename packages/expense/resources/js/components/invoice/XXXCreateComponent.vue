    ...
    <div>
        <form id="create-form">
            <div class="col-md-12">
                                        ...
                                        <div class="row col-12" style="padding: 0px;">
                                            <div class="col-md-8">
                                                <el-checkbox
                                                    ...
                                                    :key="header.id"
                                                    v-model="selectedReq[header.id]" 
                                                    :name="'check-req_'+ header.id"
                                                    size="mini"
                ...
                <br>
                <div align="right">
                    <button type="submit" class="btn btn-primary" @click.prevent="store()"> ถัดไป </button>
                </div>
            </div>
        </form>
    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            chooseReq(header){
                let vm = this;
                let checked = $('input[name="check-req_'+header.id+'"]').prop('checked');
                if(checked){
                    vm.selectedReq[header.id] = true;
                    vm.listReq.push(header.id);
                }else{
                    vm.selectedReq[header.id] = false;
