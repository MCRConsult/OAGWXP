    ...
    <div class="el_select">
        <el-select v-model="value"
            ...
            <el-option
                ...
                :key="row.remaining_receipt_number"
                :label="row.remaining_receipt_number"
                :value="row.remaining_receipt_number"
            >
            </el-option>
        </el-select>
    </div>
...
export default {
    ...
    methods: {
        getDataRows (query) {
            this.loading = true;
            axios.get(`/OAGWXP/api/invoice/get-ar-receipt`, {
                params: {
                    keyword: query
                }
            })
            .then(res => {
                ...
                this.$emit('setArReceipt', {arReceipt: this.value});
            })
            .catch((error) => {
